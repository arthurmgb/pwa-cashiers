...
<head>
    ...
    <link rel="shortcut icon" sizes="192x192" href="{{ asset('vendor/adminlte/dist/favicon/android-chrome-192x192.png') }}">
    ...
    @if(!config('adminlte.enabled_laravel_mix'))
        ...
        <link rel="stylesheet" href="{{ asset('vendor/adminlte/dist/css/my.css?ver=1.5') }}">
        <link rel="stylesheet" href="{{ asset('vendor/adminlte/dist/css/mobile.css?ver=1.5') }}">
