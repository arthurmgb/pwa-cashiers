    ...
    <div class="mbl-context">
        ...
        <div class="col-12">
            ...
            <div class="d-flex flex-row flex-wrap align-items-center justify-content-start">
                <h2 class="mbl-title-h2">Configurações</h2>
            </div>
            ...
            <div class="d-flex flex-row align-items-center justify-content-center">
                ...
                <div class="mbl-card my-2">
                    ...
                    <div class="config-card-topo mb-3">
                        ...
                        @if ($operators->count())
                            ...
                            <div class="mbl-title-block mb-2">
                                ...
                                @if (is_null($default_operator_name))
                                    <span class="period mr-1">
                                        Nenhum
                                    </span>
                                @else
                                    <span style="color: #725BC2 !important;" class="period mr-1">
                                        {{$default_operator_name->nome}}
                                    </span>
                                @endif
                            </div>

                            <div class="mbl-title-block mbl-default-operator-style">

                                <div wire:ignore data-toggle="tooltip" data-html="true" data-placement="bottom" title="O operador definido como padrão será pré-selecionado quando você criar uma nova operação para agilizar o processo. No entanto, você não poderá alterar o operador durante a criação da operação. Se precisar, desative o operador padrão para ativar novamente as opções de escolha." class="div-ttp-op-default">
                    ...
                    @if ($operators->count())
                        ...
                        <div class="accordion" id="accordionOperations">
                            ...
                            <div class="card mbl-op-item">
                                ...
                                <div class="card-header mbl-op-item-header" id="heading{{$operator->id}}">
                                <h2 class="mb-0">
                                    <button class="btn btn-block text-left mbl-op-item-btn" type="button" data-toggle="collapse" data-target="#collapse{{$operator->id}}" aria-expanded="false" aria-controls="collapse{{$operator->id}}">
                                ...
                                <div wire:ignore.self id="collapse{{$operator->id}}" class="collapse" aria-labelledby="heading{{$operator->id}}" data-parent="#accordionOperations">
                    ...
                    @else
                        ...
                        <div class="d-flex flex-column align-items-center justify-content-center mt-4">
                            ...
                            <h3 class="mt-4 mbl-no-results text-center">
                                Não há operadores a serem exibidos.
                            </h3>
                        </div>
    ...
    <div class="modal fade" data-backdrop="static" data-keyboard="false" id="edit-confirmation" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content modal-custom">
                ...
                <div class="modal-footer py-2 d-flex flex-column align-items-center justify-content-center">
                    <button style="width: 100%;" wire:loading.attr="disabled" wire:click.prevent="resetOperation()" type="button"
                        class="btn btn-cancel flex-fill order-2" data-dismiss="modal">Cancelar</button>
                    <button style="width: 100%;" wire:loading.attr="disabled" wire:click.prevent="update()" type="button"
