    ...
    <div class="mbl-context">
        ...
        <div class="col-12">
            ...
            <div class="d-flex flex-row flex-wrap align-items-center justify-content-start">
                <h2 class="mbl-title-h2">Formas de pagamento</h2>
                <span class="mbl-f-span align-self-end py-0">
                    {{ $formas_de_pagamento_count }} formas de pagamento cadastradas
                </span>
            </div>
            ...
            <div class="d-flex flex-row align-items-center justify-content-center">
                ...
                <div class="mbl-card my-2">
                    ...
                    <div class="card-topo mb-3">
                        <input wire:model="search" placeholder="buscar forma de pagamento" class="search-input mbl-search-input" autocomplete="off">
                    ...
                    @if ($formas_de_pagamento->count())
                        ...
                        <div class="accordion" id="accordionOperations">
                            ...
                            <div class="card mbl-op-item">
                                ...
                                <div class="card-header mbl-op-item-header" id="heading{{$single_fp->id}}">
                                <h2 class="mb-0">
                                    <button class="btn btn-block text-left mbl-op-item-btn" type="button" data-toggle="collapse" data-target="#collapse{{$single_fp->id}}" aria-expanded="false" aria-controls="collapse{{$single_fp->id}}">
                                ...
                                <div wire:ignore.self id="collapse{{$single_fp->id}}" class="collapse" aria-labelledby="heading{{$single_fp->id}}" data-parent="#accordionOperations">
                    ...
                    @else
                        ...
                        <div class="d-flex flex-column align-items-center justify-content-center mt-4">
                            ...
                            <h3 class="mt-4 mbl-no-results text-center">
                                Não há formas de pagamento a serem exibidas.
                            </h3>
                        </div>
    ...
    <div class="modal fade" data-backdrop="static" data-keyboard="false" id="delete-cat-confirmation" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content modal-custom">
                ...
                <div class="modal-footer py-2 d-flex flex-column align-items-center justify-content-center">
                    <button style="width: 100%;" type="button" class="btn btn-cancel flex-fill order-2" data-dismiss="modal">Cancelar</button>
                    <button style="width: 100%;" wire:loading.attr="disabled" wire:click.prevent="delete()" type="button"
                        class="btn btn-send flex-fill order-1">Confirmar</button>
                    </form>
                </div>
            </div>
