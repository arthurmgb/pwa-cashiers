    ...
    <div class="mbl-context">
        ...
        <div class="col-12">
            ...
            <div class="d-flex flex-row align-items-center justify-content-start">
                <h2 class="mbl-title-h2">Visão Geral</h2>
            </div>
            ...
            <div class="d-flex flex-column align-items-start justify-content-start">
                ...
                @if ($totais == 0)
                    ...
                    <div id="mbl-toggle-totais" class="p-2">
                        
                        <span wire:click.prevent="ocultarTotais()" class="mr-2 info-total-cx" id="tt-show">
                ...
                @elseif($totais == 1)
                    ...
                    <div id="mbl-toggle-totais-2" class="p-2">
                        <span wire:click.prevent="ocultarTotais()" class="mr-2 info-total-cx">
                            <i class="fa-fw fad fa-eye fa-lg"></i>
                        </span>
            ...
            @if($rc_soma >= 1)
                ...
                <div class="d-flex flex-row align-items-center justify-content-start">
                    <span wire:click.prevent="mostrarBoxes()" class="text-show-boxes p-2">
                        Exibir tudo ({{$rc_soma}})
                    </span>
                </div>
            ...
            <div class="d-flex flex-row flex-wrap align-items-center justify-content-center">
                    ...
                    <div class="block-vg mb-2 order-3">
                        ...
                        <div class="value-block mt-3">
                            ...
                            <div class="total-operations-done mt-2 d-flex flex-row justify-content-between align-items-center">
                                ...
                                <div class="div-ocult" wire:click.prevent="ocultarBox(1)">
                    ...
                    <div class="block-vg mb-2 order-2">
                        ...
                        <div class="value-block mt-3">
                            ...
                            <div class="total-operations-done mt-2 d-flex flex-row justify-content-between align-items-center">
                                ...
                                <div class="div-ocult" wire:click.prevent="ocultarBox(2)">
                                    <i class="fad fa-eye fa-lg"></i>
                                </div>
                            </div>
                        </div>
                ...
                @if ($rc_total == $rc)
                    ...
                    <div class="block-vg my-2 order-1">
                        ...
                        <div class="value-block mt-3">
                            ...
                            <div class="total-operations-done mt-2 d-flex flex-row justify-content-between align-items-center">
                                ...
                                <div class="div-left-oc d-flex flex-row align-items-center">
                                    <div class="div-ocult" wire:click.prevent="ocultarBox(3)">
                                        <i class="fad fa-eye fa-lg"></i>
                                    </div>            
                                </div>
                            </div>
                    ...
                    @else
                        ...
                        <div class="d-flex flex-column align-items-center justify-content-center mt-4">
                            ...
                            <h3 class="mt-4 mbl-no-results text-center">
                                Não há operações realizadas hoje.
                            </h3>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content modal-custom">
                ...
                <div class="modal-footer py-2 d-flex flex-row flex-wrap align-items-center justify-content-center">
                    ...
                    <button data-dismiss="modal" wire:loading.attr="disabled" wire:click.prevent="removeRendimento()" type="button" class="btn btn-cancel flex-fill order-2">
                        Remover
                    </button> 

                    <button data-dismiss="modal" type="button" class="btn btn-send flex-fill order-1">
                        Adicionar
                    </button>
        ...
        <div class="modal-dialog">
            <div class="modal-content modal-custom">
                ...
                <div class="modal-body py-4 px-4">
                        ...
                        <div style="user-select: none;" class="div-coins mb-0 d-flex flex-column align-items-center justify-content-center">

                            <div class="mbl-cpe-item mb-2">
                            ...
                            <div class="mbl-cpe-item mb-0">
                                <div class="div-coin-box mr-0" data-flow="bottom" data-tooltip="Retiradas">
                                    <span style="border-bottom-left-radius: 6px;" class="emoji-coin ec-totais">
                                        <i style="color: #E6274C;" class="fad fa-wallet"></i>
                                    </span>
                                    <span style="color: #E6274C;" class="coin-valor">
                ...
                <div class="modal-footer py-2 d-flex flex-row flex-wrap align-items-center justify-content-center">
                    ...
                    <button data-dismiss="modal" type="button" class="btn btn-cancel flex-fill">
                        Fechar
                    </button>
